<template>
  <main id="app">
    ...
    <section class="container chat-container">
      ...
      <RichComponent>
        <Bubble
          :text="'Greetings! I’m an informational chatbot. Please ask me questions relating to COVID-19. The health information you share with us will be used for research, education and to improve this system. We care about your privacy and will never ask you to share any personal information.'"
        />
      </RichComponent>
      <!-- Messages Table -->
